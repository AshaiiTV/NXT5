...
const checked = [];
for (const name of ['discord-publish-background', 'team-discord-publish', 'team-discord-preview', 'team-discord-test', 'publication-asset', 'team-discord-group-preview', 'team-discord-group-publish']) {
