...
const GUIDE_SECTIONS = [
  ...
  { id: "imports-and-games", label: "Importer", icon: Swords, title: "Importer une game proprement", intro: "L’import dépend du JSON NXT5 et de la confirmation du side, des lanes et des profils.", path: "/games?import=1", action: "Importer une game", steps: ["Exporter la game avec la dernière version de NXT5 Importer.", "Dans Games, ouvrir Importer une game, charger le JSON et choisir son contexte.", "Confirmer le side et les dix lanes.", "Associer les cinq profils alliés avant validation."] },
  { id: "statistics", label: "Lire les stats", icon: BarChart3, title: "Lire les chiffres dans leur contexte", intro: "Compare les rôles, puis utilise la timeline et les objectifs avant de conclure.", path: "/games", action: "Ouvrir Games", steps: ["Dans Games, rechercher puis ouvrir une game, ou choisir un groupe cohérent.", "Comparer farm, or, dégâts, vision et KP.", "Replacer les écarts dans la timeline.", "Ouvrir la source avant d’écrire une conclusion."] },
