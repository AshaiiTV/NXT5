...
const FAQ = [
  ...
  ["Le bot Discord sera-t-il inclus dans Découverte ?", "Non. Dans les offres prévues au lancement, le bot Discord et la publication des parties seront réservés au Pass Équipe payant. Ils ne seront pas inclus dans les 14 jours de Découverte. Cette présentation prépare le lancement : le paiement n’est pas ouvert et tes accès actuels restent inchangés."],
  ...
  ["Est-ce que chaque joueur devra payer ?", "Non. Découverte et Pass Équipe prévoient une équipe jusqu’à 15 membres, joueurs et encadrement compris. Le capitaine, le manager ou la structure pourra payer pour l’équipe ; ses membres n’auront pas chacun un abonnement à acheter."],
