...
export default function BotAnalyticsPage({ route = {}, navigate }) {
  ...
  return <div className="bot-analytics" data-admin-view="bot">
    <PageHeader eyebrow="Bot" title="Statistiques du bot" subtitle="Suis l’utilisation de NXT5 sur Discord : serveurs, commandes et publications de games."><Button type="button" variant="ghost" icon={RefreshCw} onClick={refresh} disabled={loading}>{loading ? "Actualisation…" : "Actualiser"}</Button></PageHeader>
