  ...
  return <div className="bot-analytics" data-admin-view="bot">
    ...
    {ready && <>
      <Surface className="bot-section"><div className="bot-metrics">
        <Metric label="Publications diffusées" value={number(summary.publications)} icon={Bot} note="Une partie par salon, comptée une fois sur la période." />
