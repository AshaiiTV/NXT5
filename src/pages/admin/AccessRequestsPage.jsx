...
export default function AccessRequestsPage({ navigate }) {
  ...
  return <div className="nxt5-data-dense access-requests-page">
    <PageHeader eyebrow="Administration · Validation commerciale" title="Demandes d’accès" subtitle="Présente l’offre aux équipes et consigne leurs retours avant l’intégration du paiement.">
    ...
    <div className="access-requests-notice"><Badge tone="cyan">Phase 1 · Sans paiement</Badge><p>Les demandes arrivent depuis la page Tarifs. Le suivi est manuel ; enregistrer un statut n’envoie aucun e-mail et n’ouvre aucun abonnement.</p></div>
