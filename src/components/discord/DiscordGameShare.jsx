...
function DiscordGameShareForm({ teamId, matchId, matchName, connection, routes, connected, coherent, revision, onReload, onClose, returnFocusRef }) {
  ...
  return <GameOperationDialog title="Publier sur Discord" description={matchName || "Partie sélectionnée"} onClose={onClose} busy={busy} returnFocusRef={returnFocusRef}>
