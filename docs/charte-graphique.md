...
Évolution autorisée le 15 septembre 2026 : les exports game, groupe, Tendances, profil joueur et pool déclaré utilisent une présentation commune centrée sur les données. Les exports reprennent les composants de dessin de `src/utils/png-report.js`.
...
- **Volumes :** les longues listes de games, de champions du groupe, du profil et du pool sont paginées. Un export d'une page télécharge un PNG ; plusieurs pages sont réunies dans un ZIP de PNG numérotés, pour éviter le blocage des téléchargements multiples. Tendances affiche explicitement les six champions les plus joués et le nombre total de champions.
- **Contrôle :** générer les vrais fichiers, vérifier le rendu et les téléchargements, les noms longs, les données absentes et les sélections volumineuses. Contrôler les accès aux exports sur mobile.
...
- `src/utils/png-report.js` : composants de dessin partagés des exports PNG, typographie, mesures, pagination et téléchargement.
