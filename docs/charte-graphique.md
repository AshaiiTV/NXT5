...
Évolutions autorisées les 15 et 21 septembre 2026 : Discord diffuse les données et visuels des games NXT5. Les réglages appartiennent à l’équipe et disposent d’une page **Bot Discord** dédiée ; le partage manuel s’ouvre à la demande sous les statistiques d’une game. Conserver les composants `Surface`, `Button`, `Badge`, `SelectInput` et `TextInput`, la palette nuit et les accents cyan, violet et fuchsia.
