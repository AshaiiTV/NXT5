...
- **Destinations :** afficher les salons accessibles et leur état de permissions, les catégories et les options de mention. Distinguer le brouillon des réglages enregistrés ; l’enregistrement ne vaut ni publication de test ni activation. Un rafraîchissement de statut conserve le brouillon. Tant qu’il n’est pas enregistré, le test et l’activation sont désactivés avec une explication. Conserver les restrictions de rôle et une aide lisible lorsqu’aucun salon n’est utilisable.
