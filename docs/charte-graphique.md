...
- **Avant la connexion :** présenter quatre étapes compactes, dans cet ordre : inviter le bot, relier l’équipe, choisir les salons, vérifier et activer. Expliquer le prochain geste utile auprès de son bouton. Le guide remplace les réglages inaccessibles par leur contexte ; il n’ajoute ni grande illustration ni succession de cartes décoratives.
...
- **Aide persistante :** après l’installation, le tutoriel reste accessible dans « Aide à la connexion · revoir les 4 étapes », replié par défaut. « Aide et résolution des problèmes » explique les permissions, la visibilité du contenu et les envois incertains. Les explications couvrent invitation, liaison, salons et activation sans afficher de jeton, de secret ou de réglage technique réservé à l’opérateur du bot.
