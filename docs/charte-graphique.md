...
- **Invitation et liaison :** un lien « Ajouter à Discord » ouvre l’autorisation officielle dans un nouvel onglet annoncé. Le bot s’invite une seule fois par serveur ; s’il est déjà présent pour une autre équipe NXT5, proposer de passer à la liaison. Chaque équipe crée son propre code et conserve un serveur relié. Plusieurs équipes peuvent partager ce même serveur. Ni la présence du bot ni l’ouverture de l’invitation ne valident la liaison de l’équipe active : seule la vérification côté serveur la confirme. Afficher la commande complète `/nxt connecter code:…`, avec « Copier la commande », retour de copie, date d’expiration et renouvellement explicites. Un code expiré ne reste pas présenté comme utilisable. La vérification automatique est bornée et annoncée ; le contrôle manuel et la vérification au retour sur l’onglet restent disponibles.
