...
- `/tarifs`, en prévisualisation administrateur, présente deux cartes : **Découverte, 30 jours d’accès complet sans carte bancaire**, et **Pass Équipe, 9,90 € TTC par mois et par équipe, résiliable à tout moment**. Les deux couvrent une équipe de 15 membres maximum avec les mêmes fonctions. Le prix reste une hypothèse à valider auprès des premières équipes. Les anciens quotas de cinq imports, une composition et trois reviews ne décrivent plus la proposition Découverte.
- Le lien « Plusieurs équipes ? Parlons de tes besoins » mène au formulaire d’échange avec le choix Structure. Aucun tarif ni fonction multi-équipe à développer n’est promis. Pass Saison, Pass Structure, annuel et fondateur sont hors de la grille de lancement ; leurs éventuels codes historiques et attributions manuelles restent conservés pour compatibilité.
- « Demander un accès » sélectionne Découverte ou le Pass Équipe et mène au formulaire de prévisualisation. Seul l’administrateur peut le soumettre ; les demandes sont enregistrées dans Neon après contrôle de ses droits et validation côté serveur. Ce formulaire ne demande aucune carte, ne démarre aucun essai de 30 jours et n’attribue aucun abonnement. Aucun paiement ni nouveau quota commercial n’est activé : les accès actuels restent inchangés. L’attribution manuelle d’un profil se fait séparément dans **Profils et abonnements**.
...
2. Après 30 jours d’accès complet sans carte bancaire, le Pass Équipe à 9,90 € TTC par mois pour toute l’équipe leur conviendrait-il ? Quels usages faudrait-il valider pendant l’essai et quelles réserves restent-elles sur le prix ?
