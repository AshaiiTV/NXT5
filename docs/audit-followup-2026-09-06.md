...
| Charge et maintenance | Sept pages chargées à la demande. AppContent passe d’environ 616 à 134 ko minifiés ; aucun module produit ne dépasse 500 ko. Bootstrap charge l’équipe active et 50 games par page, avec participants associés ; détails de timeline différés. |
| Statistiques et pagination | Portée chargée affichée avec action de chargement complet. Résumés d’objectifs conservés pour les tendances, rapports hors page accessibles et limites de compositions/archives appliquées à l’équipe active. |
