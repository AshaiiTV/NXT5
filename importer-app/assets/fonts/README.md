...
not contact Google Fonts at runtime. The four font files total 174,948 bytes.
...
| Space Grotesk | 300–700, upright | Google Fonts v22 | [SIL OFL 1.1](Space-Grotesk-OFL.txt) |

Retrieved 2026-09-06 from the [Google Fonts CSS API](https://fonts.googleapis.com/css2?family=Inter:wght@100..900&family=Space+Grotesk:wght@300..700&display=swap).
Authoritative upstream metadata and license sources:
...
- `space-grotesk-latin-variable.woff2`: https://fonts.gstatic.com/s/spacegrotesk/v22/V8mDoQDjQSkFtoMM3T6r8E7mPbF4C_k3HqU.woff2
- `space-grotesk-latin-ext-variable.woff2`: https://fonts.gstatic.com/s/spacegrotesk/v22/V8mDoQDjQSkFtoMM3T6r8E7mPb94C_k3HqUtEw.woff2

## CSS integration

Use `font-family: "Inter", sans-serif` for body copy and
`font-family: "Space Grotesk", sans-serif` for headings. Declare both subsets
...
@font-face {
  ...
  font-weight: 300 700;
  font-display: swap;
  src: url("../assets/fonts/space-grotesk-latin-ext-variable.woff2") format("woff2");
  unicode-range: U+0100-02BA, U+02BD-02C5, U+02C7-02CC, U+02CE-02D7, U+02DD-02FF, U+0304, U+0308, U+0329, U+1D00-1DBF, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20C0, U+2113, U+2C60-2C7F, U+A720-A7FF;
}
